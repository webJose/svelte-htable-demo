...
<Htable class="data4" {columns} {items} nullText="(null)">
...
<style>
	...
	:global(table.data4 summary) {
		font-style: italic;
	}
	
	:global(table.data4 tr.even) {
		background-color: rgb(231, 228, 249);
	}
	
	:global(table.data4 tr.odd) {
		background-color: white;
	}
	
	:global(table.data4 tr:not(.sub) > td:first-child) {
		background-color: rgb(39, 26, 118);
		color: white;
	}
